    ...
    >
      ...
      <div class="flex-1 w-full py-4">
        <div class="flex items-center justify-around w-full h-fit">
          ...
          ><input
            placeholder="输入联系人姓名"
            class="w-2/6 px-2 py-1 transition-all bg-slate-200 focus:bg-slate-100"
            type="text"
            v-model="info.name"
          />
          <label for="">电话</label
          ><input
            ...
            class="w-2/6 px-2 py-1 bg-slate-200"
            type="text"
            v-model="info.tel"
          />
          <button class="px-2 py-1 text-sm text-white bg-indigo-400 rounded-md">
            添加
          </button>
        </div>
      </div>
