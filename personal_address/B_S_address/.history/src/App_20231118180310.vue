      ...
      <div class="flex flex-col flex-1 w-full py-4">
        <div class="flex items-center justify-around w-full h-fit">
          ...
          ><input
            ...
            v-model="info.tel"
          />
          <button class="px-2 py-2 text-white bg-indigo-400 rounded-md">
            添加
          </button>
        </div>
        ...
        <div
          class="flex flex-col flex-1 w-10/12 mx-auto mb-4 overflow-auto bg-slate-600 rounded-xl"
        ></div>
        <div style="margin: 0 auto" class="flex text-lg w-fit">
          <button class="hover:text-indigo-400">Pre</button>
          <div class="mx-10">
            {{ pagination.page }}/{{
              Math.ceil(list.length / pagination.pageSize)
            }}
          </div>
          <button class="hover:text-indigo-400">next</button>
        </div>
      </div>
    </div>
  </div>
