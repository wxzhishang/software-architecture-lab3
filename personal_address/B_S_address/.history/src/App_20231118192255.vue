        ...
        >
          <transition-group tag="ul">
            <li
              ...
              :key="index"
            >
              <div class="text-center bg-teal-300 w-36">{{ item.name }}</div>
              <div
                class="flex items-center justify-center w-2/6 text-center bg-indigo-500"
              >
                {{ item.tel }}
              </div>
              <div class="flex justify-around w-34">
                <button>查看</button>
                <button>修改</button>
                <button>删除</button>
              </div>
