          ...
          <transition-group tag="ul">
            ...
            >
              ...
              <div class="flex justify-around w-36">
                <button
                  class="px-1 py-1 transition-all text-cyan-500 hover:text-white hover:bg-cyan-500"
                >
                  查看
                </button>
                <button
                  class="px-2 py-1 transition-all text-cyan-500 hover:text-white hover:bg-cyan-500"
                >
                  修改
                </button>
                <button
                  class="px-1 py-1 text-red-500 transition-all hover:text-white hover:bg-red-500"
                >
                  删除
                </button>
              </div>
