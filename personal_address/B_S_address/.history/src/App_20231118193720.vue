  ...
  <div id="container" class="w-full h-full font-mono font-bold text-zinc-400">
    ...
    >
      ...
      <div class="flex flex-col flex-1 w-full py-4">
        ...
        >
          <transition-group tag="ul" class="h-96">
            <li
              ...
              :key="index"
            >
              <div class="flex items-center justify-center text-center w-36">
                {{ item.name }}
              </div>
              ...
              <div class="flex justify-around w-48">
                ...
                <button
                  ...
                  class="px-2 py-2 text-red-500 transition-all rounded-lg hover:text-white hover:bg-red-500"
                >
                  删除
                </button>
              </div>
...
::-webkit-scrollbar-thumb {
  background-color: rgb(109, 111, 245);
  border-radius: 15px;
}
::-moz-scrollbar {
  width: 8px;
