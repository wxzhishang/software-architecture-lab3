...
<template>
  ...
  >
    <div
      :style="{
        transform:
          detailVisible == false ? 'translateX(30%)' : 'translateX(0%)',
      }"
      class="fixed flex flex-col w-5/12 px-4 pb-3 transition-transform divide-y-4 divide-indigo-300 rounded-lg shadow-2xl bg-zinc-50 h-5/6"
    >
